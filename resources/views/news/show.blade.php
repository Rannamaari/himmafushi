...
@endpush
<x-layouts.app :title="$article->seo_title ?: $article->title.' | Himmafushi News'" :description="$article->seo_description ?: $article->excerpt" :image="$article->image" :image-alt="$article->title" type="article">
