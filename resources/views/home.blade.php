            ...
            <div class="page-shell stay-carousel">
                @foreach($guesthouses as $guesthouse)
                    <article class="stay-card">
                        <a class="stay-card-image" href="{{ route('guesthouses.show', $guesthouse) }}"><img src="{{ $guesthouse->image ? asset('storage/'.$guesthouse->image) : asset('images/himmafushi-hero.png') }}" alt="{{ $guesthouse->name }} in Himmafushi" width="720" height="520" loading="lazy"><span class="feature-badge">Featured stay</span></a><a class="listing-card-rate-cta" href="{{ route('guesthouses.request', $guesthouse) }}">Request best rate</a>
