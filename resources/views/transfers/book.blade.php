    ...
    <section class="section"><div class="page-shell booking-layout">
        ...
        <div>
            ...
            <form method="POST" action="{{ route('transfer-bookings.store') }}" class="booking-form">
                ...
                <div class="form-field full"><div class="fare-estimate" aria-live="polite"><span>Estimated transfer fare</span><strong id="fare-total"></strong><small id="fare-detail"></small></div><button class="button booking-submit" type="submit">Confirm transfer request</button><p class="form-help">Infants aged 0-2 travel free. Your request is recorded in the booking dashboard and sent to Telegram when notifications are configured.</p></div>
            </form>
        </div>
    </div></section>
    <script>
