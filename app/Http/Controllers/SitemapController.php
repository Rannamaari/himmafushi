...
class SitemapController extends Controller
{
    public function __invoke(): Response
    {
        $pages = collect([
            ...
            ['url' => route('surfing'), 'priority' => '0.8', 'frequency' => 'weekly'],
            ['url' => route('diving'), 'priority' => '0.8', 'frequency' => 'weekly'],
            ['url' => route('snorkelling'), 'priority' => '0.8', 'frequency' => 'weekly'],
            ['url' => route('sandbank-trips'), 'priority' => '0.8', 'frequency' => 'weekly'],
            ['url' => route('dolphin-cruises'), 'priority' => '0.8', 'frequency' => 'weekly'],
            ['url' => route('island-life'), 'priority' => '0.7', 'frequency' => 'weekly'],
